#all code is same as 64 but in except we use pass to hide our failing
...
#to check fail we pass wrong book in 2nd argument
books = ["63data.txt","wrong.txt","64data.txt"]
for book in books:
    count_words(book)
